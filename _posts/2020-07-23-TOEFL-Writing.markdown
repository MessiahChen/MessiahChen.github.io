...
1. 举例论证
2. 比喻论证
3. 对比论证（类比、对比-横向不同事物对比，纵向同一事物不同阶段对比）
4. 正反对比论证（不这么做会怎么样）
5. 事实论证（统计、数据）
6. 演绎推理、归纳总结
7. 引用论证/名人名言（不推荐）
...
1. 让步句：部分接受对方观点，有明确让步方向，降低让步内容的确定性
2. 让步论证：给让步句提供一个简单的合理性证明
3. 转折句：对让步内容提出否定，强化己方观点
   - 说明己方问题可解
   - 说明双方优势共享
   - 进行双方劣势对比，强调己方观点比对方观点优点多或缺点少
   - 进行行为后果权衡，对方行为引发不良后果
4. 转折论证：支持和加强转折句的观点，解释、推论或说明原因
...
![img](/img/in-post/post-TOEFL/writing-10.png)
...
![img](/img/in-post/post-TOEFL/writing-11.png)
...
[例证法的示范](/assets/Writing-Example.pdf)
